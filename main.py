	...
	def steps(self,entry):
    	...
    	try:
        	...
        	if square > 0 :
            	...
            	self.ids.list_of_steps.add_widget(Label(text="x(1) = "  + answera,font_size = 50, size_hint_y= None, height=100))
            	self.ids.list_of_steps.add_widget(Label(text="x(2) = " + answerb,font_size = 50, size_hint_y= None, height=100))
            	self.layouts.append(layout)
